...
$rcmail_config['default_host'] = 'mail.bludotos.com';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'mail.bludotos.com';
...
$rcmail_config['support_url'] = 'index.php';
...
$rcmail_config['des_key'] = 'HZZEhKlm%B5yUiGVR=kDnPaJ';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['username_domain'] = 'bludotos.com';
...
$rcmail_config['product_name'] = 'BluDotOS';
