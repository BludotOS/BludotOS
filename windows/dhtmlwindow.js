...
init:function(wid, height, width, size, bar){
        if (!height && !width) {
               var height = window.innerHeight-document.getElementById('background').clientHeight-20;
               var width= window.innerWidth;
        }
	var windowdiv = document.createElement('div');
        if(!bar) {
	var windowdata = '<div id="topbar" class="drag-topbar" style="position:relative;top:0;left:0;width:100%;height:20px;cursor:pointer;background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.7)), to(rgba(0, 0, 0, 1)));z-index:10;background:-moz-linear-gradient(top,  rgba(0, 0, 0, 0.5),  rgba(0, 0, 0, 1));"><div id="left1" class="drag-left1" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/close-button.png"/></div><div id="left2" class="drag-left2" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/minimize-button.png"/></div><div id="left3" class="drag-left3" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/maximize-button.png"/></div></div>';
        } else if (bar) {
        var windowdata = '<div id="topbar" class="drag-topbar" style="position:relative;top:20px;left:0;width:100%;height:20px;cursor:pointer;z-index:11;"><div id="left1" class="drag-left1" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/close-button.png"/></div><div id="left2" class="drag-left2" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/minimize-button.png"/></div><div id="left3" class="drag-left3" style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;"><img style="position:relative;float:left;top:0;left:0;width:14px;height:14px;cursor:pointer;" src="icons/maximize-button.png"/></div></div>';
       }
...
document.write('<div id="dhtmlwindowholder" style="position: fixed;height: 100%;width: 100%;top: 0px;left: 0px;z-index: 88888;"></div>');
