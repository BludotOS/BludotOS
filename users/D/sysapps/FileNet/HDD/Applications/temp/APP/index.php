		...
		if (ajax3.readyState==4) {
                  ...
                  Doc.menu = function(main, lower, action)
                  {
                  	Doc.command('menu', function() {
						var nmenu = document.getElementById('menu1').cloneNode(true);
window.bar(0);
						var menu = '';
						...
						for(var i = 2; i < nmenu.children.length; i++)
{
document.getElementById('menu0').appendChild(nmenu.children[i].cloneNode(true));
}
					});
					Doc.Run('menu')	;
                  }
