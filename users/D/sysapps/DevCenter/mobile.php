...
ajax4.open('GET', 'users/<? echo $user; ?>/sysapps/FileNet/HDD/Applications/temp/'+name+'/APP_core/descript.txt', true);
	...
	ajax5.open('GET', 'users/<? echo $user; ?>/sysapps/FileNet/HDD/Applications/temp/'+name+'/APP_core/notes.txt', true);
