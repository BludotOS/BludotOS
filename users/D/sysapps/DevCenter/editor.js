...
areas = thisis[actT.x].children[1].children[0].children[2].querySelectorAll(".numbered_textarea");
//areas = thisis[actT.x].children[1].children[0].children[2].children[0];
