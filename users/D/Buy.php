...
<div id="right_sidebars">
			     ...
			     <div class="fw-text">
                             ...
                             if($session->logged_in){
                                ...
                                echo "<b1>Welcome <b2>$session->username</b2>, you are logged in.</b1> <br><br>"
                                    ...
                                    ."[<a href=\"../../users/$session->username/Mysites.php\">My websites</a>] &nbsp;&nbsp;"
                                    ."[<a href=\"../../users/$session->username/Buy.php\">Buy site</a>] &nbsp;&nbsp;"
                                    ."[<a href=\"files/users/$session->username/repair.php\">PC/Laptop repair</a>]<br> &nbsp;&nbsp;";
                                if($session->isAdmin()){
     ...
     <div id="right_sidebar_two">
			     ...
			     <div class="fw-text">
                             ...
                             <br>
                             <center>
                             <a href="files/Firefox.html" style="float: center;">Firefox on mobile</a>
                             </center>
                             <br>
                             <center>
                             <a href="files/More-Projects.html" style="float: center;">More Projects</a>
                             </center>
                             <div id="fw-sidebarend"></div>
                             </div></div></div>
     </div>
...
?>
<script>
var link = "<?= "../../users/$name/buysite.php" ?>";
</script>
...
<div id="float_center">
     ...
     <center>
     <input type="button" value="Buy Site" onClick="Redirect()">
     <center>
     </div>
</div>
</html>